...
const modal = { width: "100%", maxWidth: "480px", backgroundColor: "#455A64", borderRadius: "18px", padding: "2rem", boxShadow: "0 18px 48px rgba(0,0,0,0.45)", position: "relative", color: "#FFFFFF", fontFamily: "'Tajawal',sans-serif" };
