  ...
  return (
    <ModalWrap onClose={onClose} wide>
      ...
      <div dir={dir} style={{ minHeight: "400px" }}>
        <h2 style={{ fontSize: "1.2rem", fontWeight: 800, color: GOLD, margin: "0 0 0.6rem" }}><FiBarChart2 style={{ verticalAlign: "middle", marginInlineEnd: "0.35rem" }} />{t("chartModalTitle")}</h2>
